        ...
        <div className="flex items-center justify-center">
                ...
                <div className="hero mt-40 mb-32">
                    <div className="hero-content flex-col  md:w-full lg:w-[800px] h-[600px]">
                        ...
                        <div className="card pt-10  shrink-0 w-3/4 shadow-2xl bg-[#FFFAF9]">
                        <div className="text-center ">
                            <h1 className="text-2xl md:text-3xl lg:text-5xl font-bold mb-5 text-[#6D412A]">Register now!</h1>
                        </div>
                            <form onSubmit={handleSubmit(onSubmit)} className="card-body p-6">
                                ...
                                <div className="form-control relative">
                                    ...
                                    <label className="input input-bordered flex items-center gap-2">
                                        ...
                                        <input type={passwordState ? 'text' : 'password'} className="w-full" placeholder="Password"  {...register("password", { 
                                            ...
                                            maxLength: 20,
                                            pattern: /^(?=.*[a-z])(?=.*[A-Z]).{6,}$/})}/>
                                            <div onClick={()=>setPasswordState(!passwordState)} className="absolute right-5 top-[50px] text-[#AD795B]">
                                                {
                                ...
                                <div className="form-control mt-6">
                                    <button className="btn button-styles border-[#AD795B] bg-[#EFC7AF] hover:bg-[#AD795B] text-[#6D412A] hover:text-white lg:text-lg font-medium">Register</button>
                                </div>
                            </form>
                            <div className='mx-8 mb-8 text-center flex justify-center'>
                                <p>Already have an account? <Link className="text-[#AD795B] underline font-semibold" to={'/login'}>Login Now</Link></p>
                            </div>
